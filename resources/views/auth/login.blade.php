...
<head>
  ...
  <style>
    .bg-login-image{
        background-image: url({{ asset('asset/img/login.png') }})
    }
  </style>
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="{{ route('login') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="" name="username" placeholder="Enter Username Address...">
                      @error('username')
